<template>
    <div class="container">
        <div class="missions__header">
            ...
            <span class="uppercase">Розыгрыши</span>
        </div>
        ...
        <div id="raffle_page">
            <div class="raffle_content_wrapper">
                <div class="section_wrapper">
                    <div class="raffle_cards_wrapper">
                        <raffleHour />
                        <raffleDay />
                        <raffleWeek />
                    </div>
...
<script>
import raffleHour from "../components/raffle/raffleHour.vue";
import raffleDay from "../components/raffle/raffleDay.vue";
import raffleWeek from "../components/raffle/raffleWeek.vue";
