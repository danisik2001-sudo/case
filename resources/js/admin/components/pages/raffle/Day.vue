        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    Предметы в розыгрыше "Каждый день"
                </h3>
            </div>
        </div>
...
export default {
    ...
    methods: {
        async get() {
            const request = await axios.post("/raffle/day/load");
        ...
        async create() {
            const request = await axios.post("/raffle/day/create", {
        ...
        async del(id) {
            const request = await axios.post("/raffle/day/del", {
                id: id,
            });
            const data = request.data;
