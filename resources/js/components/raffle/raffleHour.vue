    ...
    <div class="giveawayCard">
        <div class="raffleItem__wrapper">
            <div class="raffle_card">
                <div class="top_side">
                    <div class="top_block">
                        <button class="raffle_prize_info">
                            <div class="raffle-h1 color-blue uppercase noWrap">
                                {{ $t("raffleHour.title") }}
                            </div>
                        </button>
                    ...
                    <div class="bottom_block">
                        ...
                        <button
                            v-on:click="open()"
                            type="button"
                            class="controls color--blue-gradient size--raffle full-width button"
                        >
        ...
        <div class="historyItem__wrapper">
            <div class="winner_cards_section">
                <div class="winner_card winner_card_title rarity--3">
...
export default {
    ...
    methods: {
        ...
        async get() {
            const request = await axios.post("/raffle/hour/get");
        ...
        async open() {
            const request = await axios.post("/raffle/hour/open");
