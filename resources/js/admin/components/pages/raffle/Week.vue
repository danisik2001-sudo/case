        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    Предметы в розыгрыше "Каждую неделю"
                </h3>
            </div>
        </div>
...
export default {
    ...
    methods: {
        async get() {
            const request = await axios.post("/raffle/week/load");
        ...
        async create() {
            const request = await axios.post("/raffle/week/create", {
        ...
        async del(id) {
            const request = await axios.post("/raffle/week/del", {
                id: id,
            });
            const data = request.data;
