    ...
    <div class="giveawayCard">
        <div class="raffleItem__wrapper">
            <div class="raffle_card">
                <div class="top_side">
                    <div class="top_block">
                        <button class="raffle_prize_info gold">
                            <div
                                class="raffle-h1 color-raffle-gold uppercase noWrap"
                            >
                                {{ $t("raffleWeek.title") }}
                            </div>
                        </button>
                    ...
                    <div class="bottom_block">
                        ...
                        <button
                            v-on:click="open()"
                            type="button"
                            class="controls color--raffle--gold-gradient size--raffle full-width button"
                        >
...
export default {
    ...
    methods: {
        ...
        async get() {
            const request = await axios.post("/raffle/week/get");
        ...
        async open() {
            const request = await axios.post("/raffle/week/open");
